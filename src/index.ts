...
import "./assets/css/shared_styles";
import "./index.css";

// setup
export * from "./leaf-main";
export * from "./leaf-router";

// SPA pages
export * from "./leaf-view";
export * from "./leaf-log";
export * from "./leaf-settings";
export * from "./leaf-file-editor";
export * from "./leaf-theme";
...
// Debugging
export * from "./leaf-scratch2";
export * from "./leaf-scratch3";
